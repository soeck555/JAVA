 ...
 * 상속을 받으면 ServiceV1 에 선언된 변수 , method 를 그대로 물려받는다
 * 단, 생성자 제외
 * 
...
public class StudentServiceV2 extends StudentServiceV1 {
	...
	/*
	 * Override (재 정의) ServiceV1 에 선언된 메서드 중에서 inputStudent 메서드를 다시 정의 하겠다
	 */
	@Override
	public int inputStudent() {
		...
		/*
		 * for() 가 시작되기전에 선언된 index 는 for() {} 종료되어도 값을 유지하고 있다
		 * 
		 * 만약 for() 명령문이 모두 수행되지않고 중단되면 index < strStudents.length
		 */
