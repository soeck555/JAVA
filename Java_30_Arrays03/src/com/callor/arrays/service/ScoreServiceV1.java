...
public class ScoreServiceV1 {
	 ...
	 * 		자동으로 선언된 생성자 메서드는 코드상에서는 보이지 않는다
	...
	public void makeScore() {
		for(int i = 0 ; i < intKor.length ; i ++) {
			/*
			 * random() * 50 을 연산하면 0 ~ 49 까지 범위의 임의 수가 생성된다
			 * 여기에 + 50을 하면 0일때는 51, 49일때는 100의 결과가 생성된다
	...
	public void PrintScore() {
		...
		//Line 클래스에 선언된된 dLine 속성(변수)는 static 이기 때문에
		//
		//
		// Line Line = new Line();
